...
def ResNet101(output_stride, device, BatchNorm, pretrained=True):
    ...
    """
    model = ResNet(Bottleneck, [3, 4, 23, 3], output_stride, BatchNorm, device, pretrained=pretrained)
    return model
...
if __name__ == "__main__":
    ...
    print(low_level_feat.size())        # [1, 256, 80, 80]
