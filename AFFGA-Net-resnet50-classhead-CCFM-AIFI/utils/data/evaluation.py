...
def evaluation(able_out, angle_out, width_out, class_out,target, angle_k, eval_mode, angle_th=30, iou_th=0.25, bottom=30, desc='1'):
    """
    评估预测结果
    ...
    for idx in range(pred_pts.shape[0]):
        ...
        cls_pred = class_out[row_pred, col_pred]  # 预测的抓取角类别
    ...
    return iou_flags, class_flags, succ_flags
